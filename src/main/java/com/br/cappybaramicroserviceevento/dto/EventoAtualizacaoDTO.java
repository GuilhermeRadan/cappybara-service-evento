...
public class EventoAtualizacaoDTO {
    ...
    public EventoAtualizacaoDTO(String titulo, String descricao, LocalDateTime dataHoraInicio, LocalDateTime dataHoraTermino, Double latitude, Double longitude, Long categoriaEvento, BigDecimal preco, String artistas, List<String> imagens) {
        this.titulo = titulo;
